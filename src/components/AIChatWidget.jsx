...
const GREETING =
  "Hi, I'm Flow — ClinicFlow AI's assistant. Ask me about our AI chatbots, call agents, packages, or booking a demo.";
...
const FALLBACK_MESSAGE =
  "I'm having trouble connecting right now. You can book a demo directly or reach us at contact@clinicflowai.us.";
  ...
  async function sendMessage(text) {
    ...
    try {
      ...
      setMessages((currentMessages) => [
        ...
        {
          role: "assistant",
          content: data.reply || FALLBACK_MESSAGE,
        },
      ]);
    } catch (error) {
  ...
  return (
    <>
        ...
        {open && (
          ...
          >
            <div className="flex items-center gap-3 px-4 sm:px-5 py-4 bg-teal-900 flex-shrink-0">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-white font-display text-[15px] leading-tight">
                  Flow
                </p>
                <p className="text-white/50 text-[11px] font-mono truncate">
                  ClinicFlow AI assistant
                </p>
              </div>
            ...
            <div
              ref={scrollRef}
              className="flex-1 overflow-y-auto px-4 sm:px-5 py-4 space-y-3 bg-[radial-gradient(circle_at_top_right,_#EAF4F2,_#FFFFFF_60%)]"
            >
            ...
            <form
              ...
              className="flex items-center gap-2 px-3 sm:px-4 py-3 border-t border-line bg-white flex-shrink-0"
            >
              <input
                ref={inputRef}
                type="text"
      ...
      <button
        ...
        aria-label={open ? "Close chat" : "Open chat with Flow"}
        className="fixed z-50 bottom-4 right-4 sm:bottom-6 sm:right-6 h-14 w-14 sm:h-16 sm:w-16 rounded-full bg-teal-500 shadow-lift flex items-center justify-center transition-transform duration-300 hover:-translate-y-1 hover:shadow-2xl"
      >
        {!open && (
